...
Более подробную информацию о различных метриках на множестве интервалов можно узнать из указанной `монографии <http://www.nsc.ru/interval/Library/InteBooks/SharyBook.pdf>`_.
